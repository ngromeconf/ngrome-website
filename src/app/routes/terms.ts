...
@Component({
  selector: 'app-terms',
  standalone: true,
  template: `<app-article-page title="Terms" [articles]="articles" />`,
...
export default class TermsComponent {
  articles: Article[] = [
    ...
    {
      title: 'What personal information are collected on ngrome.io?',
      paragraphs: [
    ...
    {
      title: 'Is my personal data security guaranteed?',
      paragraphs: [
